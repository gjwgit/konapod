...
Vehicle parseVehicleFromJson(Map<String, dynamic> j) {
  ...
  const knownKeys = {
    'vehicleId', 'id', 'vin', 'name', 'model', 'year', 'engine_type',
    'color', 'trim',
    ...
    'steering_wheel_heater_is_on', 'side_mirror_heater_is_on',
    'air_temperature',
  ...
  return Vehicle(
    ...
    estimatedPortableChargeMins:
        d(j['ev_estimated_portable_charge_duration']),
    estimatedStationChargeMins:
        d(j['ev_estimated_station_charge_duration']),
    targetSocAC:
