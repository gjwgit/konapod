...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _clearAndLogout() async {
    ...
    _emailCtrl.clear(); _passCtrl.clear(); _pinCtrl.clear();
  }

  @override
  void dispose() {
    _emailCtrl.dispose(); _passCtrl.dispose(); _pinCtrl.dispose();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        _SectionTitle('Bluelink Credentials'),
        ...
        const SizedBox(height: 32),
        _SectionTitle('About bluelink_fetch.py'),
        const SizedBox(height: 4),
        Text(
