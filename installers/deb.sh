...
Description: Collect and save your Hyundai Kona data
 With ${APP} your vehicles data can be stored and encrypted, in your Pod.
 The app also provides basic data analysis of your vehicle's performance.
EOL
